    ...
    <div class="container">
        ...
        <form action="{{ route('surveys.update', $survey) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" value="{{ $survey->name }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="settings[accept-guest-entries]" id="accept-guest-entries" class="form-control">
                    ...
                    <option value="false" {{ !$survey->settings['accept-guest-entries'] ? 'selected' : '' }}>No</option>
                </select>
            </div>
